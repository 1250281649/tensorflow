...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto, "tensorflow/core/framework/remote_fused_graph_execute_info.proto", 857,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_graph_input_node_name(), ptr, ctx, "tensorflow.RemoteFusedGraphExecuteInfo.graph_input_node_name");
            CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_graph_output_node_name(), ptr, ctx, "tensorflow.RemoteFusedGraphExecuteInfo.graph_output_node_name");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_executor_name(), ptr, ctx, "tensorflow.RemoteFusedGraphExecuteInfo.executor_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(_internal_mutable_serialized_executor_parameters(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* RemoteFusedGraphExecuteInfo::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(6, this->_internal_default_graph_input_tensor_shape(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(7, this->_internal_default_graph_output_tensor_shape(i), target, stream);
  }
