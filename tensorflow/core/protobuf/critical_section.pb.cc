...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fcritical_5fsection_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fcritical_5fsection_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fcritical_5fsection_2eproto, "tensorflow/core/protobuf/critical_section.proto", 348,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_critical_section_name(), ptr, ctx, "tensorflow.CriticalSectionDef.critical_section_name");
          CHK_(ptr);
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_execute_in_critical_section_name(), ptr, ctx, "tensorflow.CriticalSectionExecutionDef.execute_in_critical_section_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
