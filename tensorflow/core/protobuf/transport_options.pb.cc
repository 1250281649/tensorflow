...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto, "tensorflow/core/protobuf/transport_options.proto", 114,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(_internal_add_tensor_content(), ptr, ctx);
            CHK_(ptr);
