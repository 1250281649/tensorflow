...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2freplay_5flog_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2freplay_5flog_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2freplay_5flog_2eproto, "tensorflow/core/protobuf/replay_log.proto", 1588,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_session_handle(), ptr, ctx, "tensorflow.NewReplaySession.session_handle");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
