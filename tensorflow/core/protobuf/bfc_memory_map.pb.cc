...
const char descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rflow.MemAllocatorStatsb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto, "tensorflow/core/protobuf/bfc_memory_map.proto", 791,
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_op_name(), ptr, ctx, "tensorflow.MemChunk.op_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_allocator_name(), ptr, ctx, "tensorflow.MemoryDump.allocator_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* MemoryDump::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(2, this->_internal_bin_summary(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(3, this->_internal_chunk(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(4, this->_internal_snap_shot(i), target, stream);
  }
