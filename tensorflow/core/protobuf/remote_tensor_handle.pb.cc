...
const char descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ow.eager.ResourceDtypeAndShapeB9\n\030org.te"
  "nsorflow.frameworkB\030RemoteTensorHandlePr"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto, "tensorflow/core/protobuf/remote_tensor_handle.proto", 537,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_device(), ptr, ctx, "tensorflow.eager.RemoteTensorHandle.device");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string op_device = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_op_device(), ptr, ctx, "tensorflow.eager.RemoteTensorHandle.op_device");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* RemoteTensorHandle::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(6, this->_internal_resource_dtypes_and_shapes(i), target, stream);
  }
