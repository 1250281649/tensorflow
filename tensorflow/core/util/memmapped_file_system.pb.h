...
inline ::PROTOBUF_NAMESPACE_ID::uint64 MemmappedFileSystemDirectoryElement::_internal_offset() const {
  return offset_;
}
...
inline void MemmappedFileSystemDirectoryElement::_internal_set_offset(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 MemmappedFileSystemDirectoryElement::_internal_length() const {
  return length_;
}
...
inline void MemmappedFileSystemDirectoryElement::_internal_set_length(::PROTOBUF_NAMESPACE_ID::uint64 value) {
