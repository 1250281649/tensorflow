...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SavedSlice_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_SavedSlice_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SavedSliceMeta_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_SavedSliceMeta_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SavedTensorSliceMeta_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_SavedTensorSliceMeta_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SavedTensorSlices_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_SavedTensorSlices_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto}, {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.SavedSliceMeta.name");
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* SavedSliceMeta::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(4, this->_internal_slice(i), target, stream);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* SavedTensorSliceMeta::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_versions()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, _Internal::versions(this), target, stream);
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.SavedSlice.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
