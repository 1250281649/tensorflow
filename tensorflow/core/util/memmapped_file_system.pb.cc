...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_MemmappedFileSystemDirectory_tensorflow_2fcore_2futil_2fmemmapped_5ffile_5fsystem_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_MemmappedFileSystemDirectory_tensorflow_2fcore_2futil_2fmemmapped_5ffile_5fsystem_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MemmappedFileSystemDirectoryElement_tensorflow_2fcore_2futil_2fmemmapped_5ffile_5fsystem_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MemmappedFileSystemDirectoryElement_tensorflow_2fcore_2futil_2fmemmapped_5ffile_5fsystem_2eproto}, {}};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.MemmappedFileSystemDirectoryElement.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint64 length = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* MemmappedFileSystemDirectory::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_element(i), target, stream);
  }
