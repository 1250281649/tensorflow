...
struct FlowMetadata FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const CustomWorkgroups *workgroups() const {
    return GetPointer<const CustomWorkgroups *>(VT_WORKGROUPS);
  }
...
struct FlowMetadataBuilder {
  ...
  void add_workgroups(flatbuffers::Offset<CustomWorkgroups> workgroups) {
...
inline flatbuffers::Offset<FlowMetadata> CreateFlowMetadata(
    ...
    flatbuffers::Offset<CustomWorkgroups> workgroups = 0) {
