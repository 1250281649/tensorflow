...
struct HardcodedWorkgroup FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Uint3 *size() const {
    return GetPointer<const Uint3 *>(VT_SIZE);
  }
...
struct HardcodedWorkgroupBuilder {
  ...
  void add_size(flatbuffers::Offset<Uint3> size) {
...
inline flatbuffers::Offset<HardcodedWorkgroup> CreateHardcodedWorkgroup(
    ...
    flatbuffers::Offset<Uint3> size = 0,
...
struct HardcodedWorkgroups FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroup>> *workgroups() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroup>> *>(VT_WORKGROUPS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct HardcodedWorkgroupsBuilder {
  ...
  void add_workgroups(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroup>>> workgroups) {
...
inline flatbuffers::Offset<HardcodedWorkgroups> CreateHardcodedWorkgroups(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroup>>> workgroups = 0) {
...
inline flatbuffers::Offset<HardcodedWorkgroups> CreateHardcodedWorkgroupsDirect(
    ...
    const std::vector<flatbuffers::Offset<HardcodedWorkgroup>> *workgroups = nullptr) {
  auto gpu_info__ = gpu_info ? _fbb.CreateString(gpu_info) : 0;
  auto workgroups__ = workgroups ? _fbb.CreateVector<flatbuffers::Offset<HardcodedWorkgroup>>(*workgroups) : 0;
...
struct CustomWorkgroups FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroups>> *hardcoded_workgroups() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroups>> *>(VT_HARDCODED_WORKGROUPS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct CustomWorkgroupsBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_hardcoded_workgroups(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroups>>> hardcoded_workgroups) {
...
inline flatbuffers::Offset<CustomWorkgroups> CreateCustomWorkgroups(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<HardcodedWorkgroups>>> hardcoded_workgroups = 0) {
...
inline flatbuffers::Offset<CustomWorkgroups> CreateCustomWorkgroupsDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<HardcodedWorkgroups>> *hardcoded_workgroups = nullptr) {
  auto hardcoded_workgroups__ = hardcoded_workgroups ? _fbb.CreateVector<flatbuffers::Offset<HardcodedWorkgroups>>(*hardcoded_workgroups) : 0;
